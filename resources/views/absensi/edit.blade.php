...
@section('container')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Edit Keterlambatan Karyawan "{{ $karyawan->nama }}"</h1>
    </div>
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="/absensikaryawan/{{ $karyawan->id }}"
                        ...
                        Karyawan</a></li>
                <li class="breadcrumb-item active" aria-current="page">Edit Keterlambatan karyawan</li>
            </ol>
        </nav>
        <div class="card mb-3">
            ...
            <div class="card-body">
                ...
                <form action="/absensikaryawan/{{ $absensi->id }}" method="post">
                    ...
                    <hr>
                    <h5>Edit Keterlambatan Karyawan</h5>
                    <div class="row">
                        <div class="mb-3 col-lg-4">
                            <label for="tanggal" class="form-label">Tanggal :</label>
                            <input type="date" class="form-control @error('tanggal') is-invalid @enderror" name="tanggal"
                                id="tanggal" placeholder="dd/mm/yyyy" value="{{ old('tanggal', $absensi->tanggal) }}"
                                required>
                            @error('tanggal')
                        ...
                        <div class="mb-3 col-lg-4">
                            ...
                            <input type="time" class="form-control @error('jam_masuk') is-invalid @enderror"
                                ...
                                placeholder="{{ \Carbon\Carbon::parse($absensi->jam_masuk)->format('H:i') }}"
                        ...
                        <div class="mb-3 col-lg-4">
                            ...
                            <input type="time"
                                class="form-control @error('jam_pulang', $absensi->jam_pulang) is-invalid @enderror"
                                name="jam_pulang" id="jam_pulang"
                                placeholder="{{ \Carbon\Carbon::parse($absensi->jam_pulang)->format('H:i') }}"
