...
@section('container')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Input Sakit Karyawan "{{ $karyawan->nama }}"</h1>
    </div>
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="/sakitkaryawan/{{ $karyawan->id }}" style="text-decoration: none">Sakit
                        karyawan</a></li>
                <li class="breadcrumb-item active" aria-current="page">Input Sakit karyawan</li>
            </ol>
        </nav>
        <div class="card mb-3">
            ...
            <div class="card-body">
                ...
                <form action="/sakitkaryawan" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
